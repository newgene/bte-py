import unittest
from biothings_explorer.biothings_explorer_trapi.biothings.controllers.utils import remove_bio_link_prefix
from biothings_explorer.biothings_explorer_trapi.utils.common import remove_quotes_from_query
