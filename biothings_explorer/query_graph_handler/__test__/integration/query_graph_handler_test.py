import unittest
from biothings_explorer.query_graph_handler.query_graph import QueryGraphHandler
from biothings_explorer.query_graph_handler.query_node import QNode as QNode2
from biothings_explorer.query_graph_handler.query_edge import QEdge
from biothings_explorer.query_graph_handler.exceptions.invalid_query_graph_error import InvalidQueryGraphError
...
class TestQueryGraphHandler(unittest.TestCase):
    ...
    def test_store_nodes_if_store_nodes_with_one_hop_query(self):
        ...
        self.assertIsInstance(nodes['n0'], QNode2)
    ...
    def test_store_nodes_with_multi_hop_query(self):
        ...
        self.assertIsInstance(nodes['n0'], QNode2)
        self.assertIsInstance(nodes['n3'], QNode2)
    ...
    def test_store_edges_with_one_hop_query(self):
        ...
        self.assertIsInstance(edges['e01'].get_subject(), QNode2)
